...
import { submitSellerApplication } from '../../../lib/firebase/submitSellerApplication';
...
const schema = z.object({
  ...
  description: z.string().min(10, 'Please describe your store and products'),
...
export default function ApplySellerModal({
  open,
  onOpenChange,
}: {
  open: boolean;
  ...
  // Optional: Prefill contact info if logged in
  useEffect(() => {
  ...
  const onSubmit = async (values: FormValues) => {
    try {
      ...
      toast({
        ...
        description: 'Thanks! Your seller application has been received.',
      });
    ...
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="w-[95vw] max-w-2xl p-0 overflow-hidden">
        <DialogHeader className="px-6 pt-6">
          <DialogTitle className="text-xl sm:text-2xl">Become a Seller</DialogTitle>
          <DialogDescription>
            Apply to sell on EdxDeals. Tell us about your store and products.
          </DialogDescription>
        </DialogHeader>
        ...
        >
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            <div className="space-y-1.5">
              ...
              <Input id="storeName" placeholder="Acme Store" aria-invalid={!!errors.storeName} {...register('storeName')} />
              {errors.storeName && (
          ...
          <div className="space-y-1.5">
            ...
            <Textarea
              id="description"
              placeholder="Describe your store, product lines, fulfillment process, and unique value."
